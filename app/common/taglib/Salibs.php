...
class Salibs extends TagLib
{
    ...
    protected $tags = [
        ...
        'templates' => ['attr' => 'id'],                                               // 自定义模板
    ];

    /**
     * 自定义变量标签
     * @access public
     * @param array $tags 值或变量
     * @return string
     * @throws DataNotFoundException
     * @throws DbException
     * @throws ModelNotFoundException
     */
    public function tagVariable(array $tags)
    {
     ...
     * @throws ModelNotFoundException
     */
    public function tagCompany(array $tags)
    {
        $where = [];
     ...
     * @return string
     */
    public function tagTemplates(array $tags, string $content): string
    {
        $tags['id'] = $tags['id'] ?? 'vo';
        $id = $this->autoBuildVar($tags['id']);
        ...
        $_var = Random::alpha();
        $parse = '<?php ';
        $parse .= '$path = root_path("app/index/view/cms/custom");';
